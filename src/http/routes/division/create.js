    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            app
                ...
                var _a, nombre, descripcion, activa, division;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = request.body, nombre = _a.nombre, descripcion = _a.descripcion, activa = _a.activa;
                            return [4 /*yield*/, prisma_1.prisma.divisiones.create({
                                    data: {
                                        nombre: nombre,
