...
exports.regionesRoutes = regionesRoutes;
var zod_1 = require("zod");
var prisma_1 = require("@/lib/prisma");
function regionesRoutes(fastify) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fastify.withTypeProvider()
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, prisma_1.prisma.regiones.findMany()];
                });
            }); })
                // Get region by id
                .get('/regiones/:id', {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, prisma_1.prisma.regiones.findUnique({
