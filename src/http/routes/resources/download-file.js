            ...
            app
                ...
                schema: {
                    ...
                    querystring: zod_1.default.object({
                        path: zod_1.default.string().min(1, 'File path is required')
                    }),
                ...
                var path, fileName, stream, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, minioClient.statObject(BUCKET_NAME, path)];
                        case 2:
                            // Check if file exists
                            _a.sent();
                            return [4 /*yield*/, minioClient.getObject(BUCKET_NAME, path)];
                        case 3:
                            stream = _a.sent();
