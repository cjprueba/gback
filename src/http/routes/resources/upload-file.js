                        ...
                        schema: {
                            ...
                            response: {
                                200: zod_1.default.object({
                                    ...
                                    ruta: zod_1.default.string()
                                }),
                            },
                        },
                    }, function (request, reply) { return __awaiter(_this, void 0, void 0, function () {
                        var files, results, ruta, _a, files_1, files_1_1, data, buffer, e_1_1, error_1;
                        var _b, e_1, _c, _d;
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    _e.trys.push([0, 15, , 16]);
                                    return [4 /*yield*/, request.files()];
                                case 1:
                                    files = _e.sent();
                                    results = [];
                                    ruta = null;
                                ...
                                case 4:
                                    if (!(files_1_1 = _e.sent(), _b = files_1_1.done, !_b)) return [3 /*break*/, 7];
                                    _d = files_1_1.value;
                                    _a = false;
                                    data = _d;
                                    ruta = data.fields['ruta']['value'];
                                    buffer = data.file;
                                    return [4 /*yield*/, minioClient.putObject(BUCKET_NAME, ruta + data.filename, buffer)];
                                case 5:
                                    _e.sent();
                                    results.push({
                                ...
                                case 9:
                                    ...
                                    if (!(!_a && !_b && (_c = files_1.return))) return [3 /*break*/, 11];
                                ...
                                case 15:
                                    ...
                                    if (error_1 instanceof bad_request_error_1.BadRequestError) {
                                        throw error_1;
                                    }
