...
exports.provinciaRoutes = provinciaRoutes;
var zod_1 = require("zod");
var prisma_1 = require("@/lib/prisma");
function provinciaRoutes(fastify) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fastify.withTypeProvider()
                ...
                var region_id, whereClause;
                return __generator(this, function (_a) {
                    region_id = request.query.region_id;
                    whereClause = region_id ? { region_id: region_id } : {};
                    return [2 /*return*/, prisma_1.prisma.provincias.findMany({
                            where: whereClause
                        })];
                });
            }); })
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, prisma_1.prisma.provincias.findUnique({
